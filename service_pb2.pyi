...
class PlayerActions(_message.Message):
    ...
    def __init__(self, actions: _Optional[_Iterable[_Union[PlayerAction, _Mapping]]] = ..., ignore_preprocess: bool = ...) -> None: ...
